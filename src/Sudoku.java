...
public class Sudoku {
   public static void main(String[] args) throws IOException {
      ...
      out.println("Enter each row of the Sudoku you'd like to solve, using 0's for blank squares.\n" +
         ...
         "Type exit to exit. Otherwise, type anything to continue.\n");
      ...
      do{
         for (int i = 0; i < 9; i++) {
            ...
            for (int j = 0; j < 9; j++) {
               ...
               try {
                  ...
                  else grid[i][j] = Integer.parseInt(s);
         ...
         out.println("Type exit if you would like to exit. Otherwise type anything to solve another Sudoku puzzle.");
